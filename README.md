...
```javascript
import colcat from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-colcat@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-colcat@deno/mod.js';
```
