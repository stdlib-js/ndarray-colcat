...
```javascript
colcat = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-colcat@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var colcat = require( 'path/to/vendor/umd/ndarray-colcat/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-colcat@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-colcat.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-colcat

[test-image]: https://github.com/stdlib-js/ndarray-colcat/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/ndarray-colcat/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-colcat/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-colcat?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-colcat.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-colcat/main
...
[deno-url]: https://github.com/stdlib-js/ndarray-colcat/tree/deno
[deno-readme]: https://github.com/stdlib-js/ndarray-colcat/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-colcat/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-colcat/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-colcat/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-colcat/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-colcat/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/ndarray-colcat/main/LICENSE
